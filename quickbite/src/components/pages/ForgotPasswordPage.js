...
export default function ForgotPasswordPage({ navigate }) {
  ...
  const isValidEmail = email.endsWith('@dsuniversity.ac.in');
          ...
          <>
            ...
            <form onSubmit={handleSendOTP}>
              ...
              <div className="form-group">
                ...
                <input type="email" className={`form-input ${(email && !isValidEmail) ? 'error' : ''}`} value={email} onChange={e => setEmail(e.target.value)} required disabled={loading} placeholder="your@dsuniversity.ac.in" />
              </div>
